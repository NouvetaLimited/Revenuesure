                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Miscelleneous </div>
                            </div>
                            ...
                            <div class="card-body " id="bar-parent">
                                <form>
                                    <div class="form-group">
                                        <label for="simpleFormEmail">Bill Number</label>
                                        <input type="text" class="form-control" id="simpleFormEmail" placeholder="Enter bill number">
                                    </div>
                                    <div class="form-group">
